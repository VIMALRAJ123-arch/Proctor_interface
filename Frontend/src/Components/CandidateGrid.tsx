    ...
    if (candidates.length === 0) {
        return (
            <div className="h-full w-full flex flex-col items-center justify-center p-8 text-center bg-brand transition-colors duration-500">
                <div className="w-20 h-20 bg-surface rounded-3xl flex items-center justify-center mb-6 border border-border-subtle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8 max-w-[1600px] mx-auto relative">
            {candidates.map((candidate, idx) => (
                <motion.div
                    ...
                    className="bg-surface rounded-[2.5rem] border border-border-subtle overflow-hidden group hover:border-accent-main/30 shadow-2xl transition-all relative"
                >
                    <div
                    ...
                    >
                        ...
                        <div className="absolute bottom-4 left-5 right-5 flex items-center justify-between z-10">
                            {candidate.cameraOn && (
                                <div className="px-3 py-1.5 bg-status-active/10 backdrop-blur-md border border-status-active/20 rounded-lg flex items-center gap-1.5 animate-in fade-in slide-in-from-bottom-2">
                                    <div className="w-1.5 h-1.5 rounded-full bg-status-active animate-pulse shadow-[0_0_8px_var(--color-status-active)]" />
                    ...
                    <div className="p-6 flex items-center justify-between font-black">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className={`p-2.5 rounded-xl border transition-all ${candidate.flags.length > 0
                            ...
                            <div className="px-3 py-1.5 bg-surface rounded-lg border border-border-subtle font-black">
